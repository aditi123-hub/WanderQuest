...
export default function TripDetail() {
  ...
  const handleCheckIn = async () => {
    ...
    try {
      await axios.post(`http://localhost:5000/api/trips/${tripId}/checkin`, {
  ...
  const lng = trip.coordinates?.lng || 77.2090;

  return (
    <div className="tripdetail-container">

      {/* ⭐ BACK BUTTON FIXED → GOES TO DASHBOARD */}
      ...
      <div className="journal-box">
        ...
        <input
          type="file"
          accept="image/*"
          onChange={(e) => handlePhotoUpload(e, setJournalPhoto)}
        />
        ...
        <div className="journal-entry" key={j._id}>
          {editingId === j._id ? (
            ...
            <>
              ...
              <p>
                🕒 {new Date(j.date).toLocaleString()} — {j.content || "(No content)"}
              </p>
